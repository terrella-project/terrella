...
- Authoritative routing config: [`../ai-observability/litellm/config.yaml`](../ai-observability/litellm/config.yaml) on Earth-AI. Lists all backend models (anthropic/*, gemini/*, ollama/*), per-key spend caps, model aliases.
...
| LiteLLM | `/home/john/src/earth-ai/ai-observability/litellm/config.yaml` |
