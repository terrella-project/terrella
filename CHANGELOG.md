...
- **CI: `auto-close-epics` workflow** — backported from `mkzsystems/pm-framework`; closes a parent epic when its last sub-issue closes (predicate matches the Epic issue type or the `epic` label). (#111)
