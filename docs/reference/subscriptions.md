...
- `stack/.env` — generated by `scripts/generate-env.sh`; fill in `ANTHROPIC_API_KEY`, `GEMINI_API_KEY`, `OPENAI_API_KEY` after generation. See [setup/06-observability-stack.md](../setup/06-observability-stack.md#62-environment-variables).
