...
- Open WebUI (8080) and Grafana (3000) bind on all interfaces — reachable over Tailscale from jupiter / Mac mini. LiteLLM (4000) and Prometheus (9090) bind to `127.0.0.1` only.
